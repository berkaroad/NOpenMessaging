...
namespace NOpenMessaging.Messaging
{
    ...
    public interface IHeader
    {
         ...
         */
        IHeader setDestination(string destination);
         ...
         */
        IHeader setMessageId(string messageId);
         ...
         */
        IHeader setBornTimestamp(long bornTimestamp);
         ...
         */
        IHeader setBornHost(string bornHost);
         ...
         */
        IHeader setCompression(short compression);
