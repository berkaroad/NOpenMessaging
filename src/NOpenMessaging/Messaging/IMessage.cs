...
namespace NOpenMessaging.Messaging
{
    ...
    public interface IMessage
    {
         ...
         */
        [Optional]
        IExtensionHeader extensionHeader();
         ...
         *
         * @see Consumer#ack(NOpenMessaging.consumer.MessageReceipt)
         * @see MessageListener.Context#ack()
         * @see BatchMessageListener.Context#success(NOpenMessaging.consumer.MessageReceipt...)
         */
        IMessageReceipt getMessageReceipt();
